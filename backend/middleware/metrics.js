  ...
  res.on('finish', () => {
    ...
    if (userAgent.includes('Mobile') || userAgent.includes('Android') || userAgent.includes('iPhone')) {
      const platform = userAgent.includes('Android') ? 'android' : 
                     userAgent.includes('iPhone') ? 'ios' : 'mobile';
...
const recordAiResponseTime = (duration, subject = 'general', complexity = 'medium') => {
...
const recordQuestion = (subject = 'general', gradeLevel = 'unknown', status = 'success') => {
  questionCounter
    .labels(subject, gradeLevel, status)
    .inc();
};
