const commonResponses = {
  ...
  programming: {
    'what is a variable': {
      response:
        "A named container that stores data in a program.\n\nCharacteristics:\n  - Has a name (identifier)\n  - Holds a value\n  - Can change during program execution\n\nExample in JavaScript:\n  let age = 25;\n  let name = 'Alice';",
      complexity: 'basic',
    },
    'what is a function': {
      response:
  ...
  general: {
    hi: {
      response:
        "Welcome! Let's explore math, science, history, programming, or any other subject you're interested in learning about.",
      complexity: 'basic',
    },
    hello: {
      response:
...
function checkCommonResponse(question, subject = null) {
  ...
  if (subject && commonResponses[subject.toLowerCase()]) {
    const subjectResponse =
      commonResponses[subject.toLowerCase()][normalizedQuestion];
    if (subjectResponse) {
      return {
        found: true,
        ...subjectResponse,
