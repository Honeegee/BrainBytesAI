...
export default function LearningMaterialUpload({ subject, onSuccess }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const errorMessage = err.response?.data?.error?.message || err.response?.data?.error || 'Failed to upload material';
  ...
  return (
    <div className="bg-bg-dark-secondary rounded-xl p-6">
      <h2 className="text-xl font-semibold text-text-light mb-6">Add Material to {subject}</h2>
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <input
                ...
                className="w-full p-3 rounded-lg bg-gray-700 border border-gray-600 text-text-light focus:outline-none focus:ring-2 focus:ring-hf-blue"
              />
              <p className="mt-1 text-sm text-text-medium">Separate tags with commas</p>
            </div>
          </div>
              ...
              <div className="flex gap-6">
                <label className="flex items-center">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-text-medium">PDF, DOC, DOCX, TXT (Max 5MB)</p>
                  </div>
                </label>
                <label className="flex items-center">
                  <input
                  ...
                  <div>
                    ...
                    <p className="text-sm text-text-medium">Type or paste content directly</p>
                  </div>
                </label>
              </div>
            </div>
