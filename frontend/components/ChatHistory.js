...
export default function ChatHistory({
  ...
  const filteredGroups = Object.entries(groupedChats).reduce(
    (acc, [date, dateChats]) => {
  ...
  return (
    <div
      className={`${isOpen ? 'w-72' : 'w-16'} bg-bg-dark-secondary h-full flex flex-col border-r border-border-dark transition-all duration-200`}
    >
        ...
        >
          ...
          >
            <path
              ...
              d={
                isOpen
                  ? 'M15 10a1 1 0 01-1 1H6a1 1 0 110-2h8a1 1 0 011 1z'
        ...
        <>
          <div className='p-2 border-b border-border-dark'>
            <div className='relative'>
              ...
              <svg
                xmlns='http://www.w3.org/2000/svg'
                className='h-4 w-4 absolute right-3 top-2.5 text-text-medium'
                fill='none'
                viewBox='0 0 24 24'
                stroke='currentColor'
              >
