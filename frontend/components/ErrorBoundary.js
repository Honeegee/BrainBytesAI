...
const STYLES = {
  CONTAINER: "p-8 text-center max-w-2xl mx-auto my-8 bg-white rounded-lg shadow-sm",
  TITLE: "text-red-600 text-2xl font-semibold mb-4",
  MESSAGE: "text-gray-600 mb-6",
  BUTTON: "bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700 transition-colors",
  ERROR_DETAILS: "mt-4 p-4 bg-gray-100 rounded text-left text-sm text-gray-700 overflow-auto"
};
